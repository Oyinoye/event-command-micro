...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8087';
    'jhipster.clientApp.name' = 'maxevent';
    ...
    'jhipster.mail.from' = 'maxevent@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'maxevent API';
    'jhipster.swagger.description' = 'maxevent API documentation';
    ...
    'eureka.instance.appname' = 'maxevent';
    'eureka.instance.instanceId' = 'maxevent:${random.value}';
